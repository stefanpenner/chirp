...
- **Functions / scripts** — `f of x` / multi-arg; tuples/sets/rows/columns; matrix; intervals; ∅; set ops ∪∩∖; `norm of v` → ‖v‖; transpose/inverse/dagger/trace/rank; `x sub i` / `x super n`
