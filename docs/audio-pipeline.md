...
- **N and a half / quarter** — general mixed fractions (`six and a half` → `6½`, `six and a quarter` → `6¼`, `ten and three quarters` → `10¾`)
- **Spoken list compounds** — `number twenty one` → `21.` (tens+unit, not leftover “one”)
