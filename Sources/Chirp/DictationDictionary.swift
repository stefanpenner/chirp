...
enum DictationDictionary {
    ...
    static let builtIn: [String: String] = [
        ...
        // Common multi-word jargon ASR splits (SOTA offline: custom vocab)
        "dev ops": "DevOps",
        "git ops": "GitOps",
        "front end": "frontend",
        "back end": "backend",
        ...
        "super base": "Supabase",
        "fire base": "Firebase",
        // More tech / AI / build ASR confusions
        "x a i": "xAI",
        "ex a i": "xAI",
        "g rock": "Grok",
        "bay zel": "Bazel",
        ...
        "cursor a i": "Cursor",
        "vs code in siders": "VS Code Insiders",
        ...
        "x code cloud": "Xcode Cloud",
        "fast lane": "fastlane",
        "coco a pods": "CocoaPods",
        "swift data": "SwiftData",
        // Avoid "async/await" string literal — Swift parses /await as keyword.
        "async await": "async" + "/" + "await",
        "actor isolated": "actor-isolated",
    ]
