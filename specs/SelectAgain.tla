...
(*
  ...
  Seed (SelectPhrase): select X, select that (last stack delta), select last
  word(s), or unit select last/first/next sentence|paragraph|line — all call
  rememberSelectSearch so select again has a target.
